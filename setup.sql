...
CREATE TABLE teams (id int NOT NULL AUTO_INCREMENT, name varchar(255), competition_id int NOT NULL, points int, point_difference int, PRIMARY KEY(id), UNIQUE KEY(name), FOREIGN KEY(competition_id) REFERENCES competitions(id));
...
CREATE TABLE judges (id int NOT NULL AUTO_INCREMENT, name varchar(255), username varchar(255), passhash varchar(255), salt varchar(255), is_admin bool, PRIMARY KEY(id), UNIQUE KEY(name), UNIQUE KEY(username));
