...
CREATE TABLE teams (id int NOT NULL AUTO_INCREMENT, name varchar(255), competition_id int NOT NULL, points int DEFAULT '0', points_difference int DEFAULT '0', PRIMARY KEY(id), UNIQUE KEY(name), FOREIGN KEY(competition_id) REFERENCES competitions(id));
