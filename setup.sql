...
CREATE TABLE teams (id int NOT NULL AUTO_INCREMENT, name varchar(255), school varchar(255), competition_id int NOT NULL, points int DEFAULT '0', point_difference int DEFAULT '0', PRIMARY KEY(id), UNIQUE KEY(name), FOREIGN KEY(competition_id) REFERENCES competitions(id));
...
CREATE TABLE battles (id int NOT NULL AUTO_INCREMENT, day int, team1 int NOT NULL, team2 int NOT NULL, points1 int, points2 int, judges varchar(255) DEFAULT '[]', challenges varchar(1023) DEFAULT '[]', PRIMARY KEY(id), FOREIGN KEY(team1) REFERENCES teams(id), FOREIGN KEY(team2) REFERENCES teams(id));
