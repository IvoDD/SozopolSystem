...
CREATE TABLE battles (id int NOT NULL AUTO_INCREMENT, day int, team1 int NOT NULL, team2 int NOT NULL, points1 int, points2 int, judges varchar(255) DEFAULT '[]', challenges varchar(255) DEFAULT '[]', PRIMARY KEY(id), FOREIGN KEY(team1) REFERENCES teams(id), FOREIGN KEY(team2) REFERENCES teams(id));
